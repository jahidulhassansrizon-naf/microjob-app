    ...
    <>
      <main className="lg:col-span-6 bg-[#1A1F2F] border border-gray-700/60 rounded-3xl p-5 md:p-6 flex flex-col items-center justify-center relative min-h-[520px] shadow-lg">
        ...
        {!activePhoto && photoMode !== "dual" ? (
          <div
            className={`max-w-md w-full border-2 border-dashed rounded-2xl p-8 flex flex-col items-center justify-center text-center gap-4 bg-[#282E3B]/60 cursor-pointer transition ${isDragging ? "border-amber-400 ring-2 ring-amber-400/30" : "border-gray-600/70 hover:border-gray-500"}`}
              ...
              <>
                    ...
                    {[0, 1].map((index) => {
                      ...
                      return (
                        <div
                          ...
                          className={`relative overflow-hidden rounded-lg border-2 ${activeDualSlot === index ? "border-amber-400" : "border-white/10"} bg-white flex items-center justify-center cursor-pointer`}
                        >
                          {photo ? (
                            <img
                              src={photo.url}
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className={`px-4 py-2 rounded-xl text-xs font-black ${activeDualSlot === 0 ? "bg-amber-500 text-gray-900" : "bg-[#282E3B] text-white"}`}
                  >
                    Left
                  </button>
                  <button
                    ...
                    className={`px-4 py-2 rounded-xl text-xs font-black ${activeDualSlot === 1 ? "bg-amber-500 text-gray-900" : "bg-[#282E3B] text-white"}`}
                  >
                    Right
                  </button>
                  <button
              ...
              <>
                ...
                <div className="flex items-center gap-2 flex-wrap justify-center">
                  ...
                  <button
                    ...
                    className={`h-9 px-3 rounded-lg text-xs font-black flex items-center gap-1 ${flipX ? "bg-amber-500 text-gray-900" : "bg-[#282E3B] text-white"}`}
                  >
