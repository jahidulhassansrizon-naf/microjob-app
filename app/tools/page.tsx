...
export default function ToolsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FFFBF7] text-gray-950 flex flex-col">
      {/* Hero / Header Section */}
      <div className="max-w-[1200px] mx-auto px-6 pt-16 pb-10 w-full flex flex-col items-center text-center">
        <div className="bg-orange-50 border border-orange-200/60 text-orange-600 text-xs font-bold px-4 py-1.5 rounded-full mb-6 shadow-2xs">
          50+ Easy Tools
        </div>

        <h1 className="text-4xl md:text-6xl font-black tracking-tight text-gray-900 max-w-4xl leading-[1.15] mb-6">
          All your conversion work,{" "}
          <span className="text-orange-500">in one place—</span> simple & fast
        </h1>

        <p className="text-sm md:text-base text-gray-500 font-medium max-w-xl mb-10">
        ...
        <div className="relative w-full max-w-xl mb-8">
          ...
          <input
            ...
            className="w-full bg-white border border-gray-200/80 rounded-full pl-12 pr-20 py-3.5 text-sm shadow-sm focus:outline-none focus:border-orange-500 transition"
          />
          <div className="absolute inset-y-0 right-3 flex items-center pointer-events-none">
            <span className="text-[10px] font-bold bg-gray-100 border border-gray-200 text-gray-500 px-2 py-1 rounded-md">
              Ctrl K
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 bg-white border border-gray-200/60 p-1.5 rounded-full shadow-2xs">
          {[
            "All Tools",
            "PDF Tools",
            "Image Tools",
      ...
      <main className="flex-grow max-w-[1200px] mx-auto px-6 pb-24 w-full flex flex-col gap-12">
          ...
          return (
            <section key={catIdx} className="flex flex-col gap-4">
              ...
              <div className="flex items-center justify-between border-b border-gray-200/60 pb-3">
                ...
                <Link
                  href="#"
                  className="text-xs font-bold text-gray-500 hover:text-orange-500 transition"
                >
                  See all tools &gt;
                </Link>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {category.tools.map((tool, tIdx) => (
                  <Link
                    key={tIdx}
                    href={tool.href}
                    className="bg-white border border-gray-100 rounded-2xl p-4 shadow-2xs hover:shadow-md hover:border-orange-200 transition flex items-start gap-3.5 group"
                  >
