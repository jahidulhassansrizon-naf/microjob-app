  ...
  return (
    <div className="w-full space-y-5 text-gray-800 font-sans">
      ...
      <div className="flex items-center gap-2 text-xs text-gray-500">
        ...
        <span>PDF Tools</span>
        <span>/</span>
        <span className="font-semibold text-gray-900">Extract Images</span>
      </div>
        ...
        <div className="flex items-center gap-3.5">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 font-medium mt-0.5">
              Pull embedded photos and graphics out of your PDF as high-quality
              JPG files.
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
        {/* Left Side: Upload Box & Extra Info Box */}
        <div className="lg:col-span-4 space-y-4">
          <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-xs flex flex-col justify-between">
            <div>
              ...
              {!selectedFile ? (
                <label className="border-2 border-dashed border-red-200 bg-red-50/30 hover:bg-red-50/60 rounded-2xl p-8 flex flex-col items-center justify-center text-center cursor-pointer transition-all group min-h-[200px]">
          ...
          {/* Additional Info Note Card */}
          <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-xs space-y-1.5">
            <h3 className="text-xs font-bold text-gray-900">
              Extracts embedded images only. Scanned PDFs (full-page images) may
              not contain separate extractable images.
            </h3>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-xs overflow-hidden">
        ...
        {showHowToUse && (
          <div className="px-5 pb-4 text-xs text-gray-500 leading-relaxed border-t border-gray-50 pt-3">
            Upload your PDF document, click "Extract images", and download all
            embedded images as high-quality individual files.
          </div>
        )}
      </div>
