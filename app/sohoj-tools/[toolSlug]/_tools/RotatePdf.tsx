  ...
  return (
    <div className="w-full space-y-5 text-gray-800 font-sans">
      ...
      <div className="flex items-center gap-2 text-xs text-gray-500">
        ...
        <span>PDF Tools</span>
        <span>/</span>
        <span className="font-semibold text-gray-900">Rotate PDF</span>
      </div>
        ...
        <div className="flex items-center gap-3.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-lg font-bold text-gray-900">Rotate PDF</h1>
              <span className="bg-emerald-100 text-emerald-700 text-[10px] font-bold px-2 py-0.5 rounded-full">
                Free
              </span>
            </div>
            <p className="text-xs text-gray-500 font-medium mt-0.5">
              Turn pages upright — rotate all pages or only the ones you choose.
            </p>
          </div>
        </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-xs overflow-hidden">
        ...
        {showHowToUse && (
          <div className="px-5 pb-4 text-xs text-gray-500 leading-relaxed border-t border-gray-50 pt-3">
            Upload your PDF file, choose the rotation angle or pages you wish to
            rotate, and click "Rotate PDF" to process.
          </div>
        )}
      </div>
