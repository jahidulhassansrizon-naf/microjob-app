...
import Link from "next/link"; // এটি ঠিক করা হয়েছে
...
export default function TrimCutVideo() {
      ...
      <div className="w-full space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-gray-500 font-medium mt-1">
              Cut unwanted sections from a video — set start and end times, then
              export the clip as MP4.
            </p>
          </div>
                  ...
                  <div className="space-y-3 pt-2 border-t border-gray-100">
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className="w-full bg-gray-50 border border-gray-200 rounded-xl px-3 py-1.5 text-xs font-semibold text-gray-800 focus:outline-none focus:border-purple-500"
                      />
                    </div>
              ...
              <div>
                <div className="flex items-center justify-between pb-3 border-b border-gray-100">
                  ...
                  <span className="text-[11px] font-semibold text-gray-400 bg-gray-100 px-2.5 py-0.5 rounded-md">
                    {selectedFile ? (isTrimmed ? "Trimmed" : "Ready") : "Empty"}
                  </span>
                </div>
                    ...
                    <div className="py-16 space-y-3">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] text-gray-400 mt-0.5">
                          Use the timeline sliders to pick the section you want
                          to keep.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="w-full space-y-4">
                      ...
                      {isTrimmed && (
                        <div className="flex items-center justify-center gap-1.5 text-xs font-bold text-emerald-600 bg-emerald-50 py-1.5 px-3 rounded-lg w-max mx-auto">
                          ...
                          <span>
                            Video trimmed successfully from {startTime}s to{" "}
                            {endTime}s!
                          </span>
                        </div>
                      )}
        ...
        <div className="bg-white border border-gray-200/80 rounded-2xl p-4 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-2xs">
          <div className="text-xs font-medium text-gray-500 flex items-center gap-2">
            ...
            <span>
              {!selectedFile
                ...
                : isTrimmed
                  ? "Ready to download your trimmed clip"
                  : "Ready to trim video file"}
            </span>
          </div>
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto justify-end">
            ...
            {!isTrimmed ? (
              <button
                disabled={!selectedFile || isTriming}
                ...
                className={`px-5 py-2 bg-purple-600 hover:bg-purple-700 text-white text-xs font-bold rounded-xl transition-all shadow-sm flex items-center gap-2 ${
                  !selectedFile || isTriming
                    ? "opacity-50 cursor-not-allowed"
                    : ""
                }`}
              >
                {isTriming && <RefreshCw size={14} className="animate-spin" />}
                <span>{isTriming ? "Triming..." : "Trim video"}</span>
              </button>
            ) : (
              <button
                onClick={() => alert("Downloading trimmed video...")}
        ...
        <div className="bg-white border border-gray-200/80 rounded-2xl overflow-hidden shadow-2xs">
          ...
          {showHowToUse && (
            <div className="p-4 pt-0 text-xs text-gray-600 space-y-2 border-t border-gray-100 font-medium leading-relaxed">
              ...
              <p>
                2. Set the desired start and end times in seconds to cut the
                video segment you want.
              </p>
              <p>
                3. Click &quot;Trim video&quot; and download your exported clip
                instantly.
              </p>
            </div>
          )}
