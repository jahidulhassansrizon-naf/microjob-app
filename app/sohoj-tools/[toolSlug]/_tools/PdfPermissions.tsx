  ...
  return (
    <div className="w-full space-y-5 text-gray-800 font-sans">
      ...
      <div className="flex items-center gap-2 text-xs text-gray-500">
        ...
        <span>PDF Tools</span>
        <span>/</span>
        <span className="font-semibold text-gray-900">PDF Permissions</span>
      </div>
        ...
        <div className="flex items-center gap-3.5">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 font-medium mt-0.5">
              Restrict printing, copying, or editing of your PDF without locking
              it from opening.
            </p>
          </div>
        </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-xs overflow-hidden">
        ...
        {showHowToUse && (
          <div className="px-5 pb-4 text-xs text-gray-500 leading-relaxed border-t border-gray-50 pt-3">
            Upload your PDF file, set restrictions on copying, printing, or
            editing, then click "Set permissions" to download the updated PDF.
          </div>
        )}
      </div>
