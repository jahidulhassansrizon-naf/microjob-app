        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2 text-xs text-gray-500 font-medium mb-2">
              ...
              <span>/</span>
              <span className="text-gray-900 font-semibold">Rotate / Flip</span>
            </div>
            ...
            <p className="text-xs text-gray-500 font-medium mt-1">
              Rotate or flip your video files easily right in your browser.
            </p>
          </div>
                    ...
                    <div className="space-y-1.5 pt-1">
                      ...
                      <div className="grid grid-cols-2 gap-1.5">
                        <button
                          ...
                          className={`py-2 px-3 text-[11px] font-bold rounded-lg border transition-all flex items-center justify-center gap-1.5 ${
                            isFlippedH
                              ? "bg-emerald-600 text-white border-emerald-600 shadow-2xs"
                              : "bg-gray-50 text-gray-700 border-gray-200 hover:bg-gray-100"
                          }`}
                    ...
                    <div className="py-16 space-y-3">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] text-gray-400 mt-0.5">
                          Upload a video to rotate or flip it according to your
                          needs.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="w-full space-y-4">
                      ...
                      {isProcessed && (
                        <div className="flex items-center justify-center gap-1.5 text-xs font-bold text-emerald-600 bg-emerald-50 py-1.5 px-3 rounded-lg w-max mx-auto">
                          ...
                          <span>Video rotated/flipped successfully!</span>
                        </div>
                      )}
                    </div>
                  )}
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto justify-end">
            ...
            {!isProcessed ? (
              ...
              >
                ...
                <span>{isProcessing ? "Processing..." : "Rotate video"}</span>
              </button>
            ) : (
              <button
                onClick={() => alert("Downloading rotated video...")}
                className="px-5 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-xl transition-all shadow-sm flex items-center gap-2"
              >
                <Download size={14} />
        ...
        <div className="bg-white border border-gray-200/80 rounded-2xl overflow-hidden shadow-2xs">
          ...
          {showHowToUse && (
            <div className="p-4 pt-0 text-xs text-gray-600 space-y-2 border-t border-gray-100 font-medium leading-relaxed">
              ...
              <p>
                2. Select the rotation angle or apply horizontal/vertical flips.
              </p>
              <p>
                3. Click &quot;Rotate video&quot; and download your modified
                file instantly.
              </p>
            </div>
          )}
