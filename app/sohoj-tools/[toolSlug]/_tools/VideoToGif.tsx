        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2 text-xs text-gray-500 font-medium mb-2">
              ...
              <span>/</span>
              <span className="text-gray-900 font-semibold">Video to GIF</span>
            </div>
            ...
            <p className="text-xs text-gray-500 font-medium mt-1">
              Convert video clips into high-quality animated GIFs directly in
              your browser.
            </p>
          </div>
                  ...
                  {!selectedFile ? (
                    <div className="py-16 space-y-3">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] text-gray-400 mt-0.5">
                          Upload a video to convert it into a smooth GIF
                          animation.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="w-full space-y-4">
                      <div className="max-w-md mx-auto rounded-xl overflow-hidden shadow-md bg-gray-900 p-6 text-white text-center space-y-2">
                        <Film size={32} className="mx-auto text-emerald-400" />
                        <p className="text-xs font-bold">
                          GIF Quality: {frameRate} FPS
                        </p>
                      ...
                      {isProcessed && (
                        <div className="flex items-center justify-center gap-1.5 text-xs font-bold text-emerald-600 bg-emerald-50 py-1.5 px-3 rounded-lg w-max mx-auto">
                          ...
                          <span>Converted to GIF successfully!</span>
                        </div>
                      )}
                    </div>
                  )}
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto justify-end">
            ...
            {!isProcessed ? (
              ...
              >
                ...
                <span>{isProcessing ? "Processing..." : "Convert to GIF"}</span>
              </button>
            ) : (
              <button
                onClick={() => alert("Downloading GIF file...")}
                className="px-5 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-xl transition-all shadow-sm flex items-center gap-2"
              >
                <Download size={14} />
        ...
        <div className="bg-white border border-gray-200/80 rounded-2xl overflow-hidden shadow-2xs">
          ...
          {showHowToUse && (
            <div className="p-4 pt-0 text-xs text-gray-600 space-y-2 border-t border-gray-100 font-medium leading-relaxed">
              ...
              <p>2. Adjust the desired frame rate (FPS) if necessary.</p>
              <p>
                3. Click &quot;Convert to GIF&quot; and download your animated
                file instantly.
              </p>
            </div>
          )}
