...
export default function AddWatermarkToVideo() {
  ...
  const [watermarkText, setWatermarkText] = useState<string>("Sohoj Tools");
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2 text-xs text-gray-500 font-medium mb-2">
              ...
              <span>/</span>
              <span className="text-gray-900 font-semibold">Add Watermark</span>
            </div>
            ...
            <p className="text-xs text-gray-500 font-medium mt-1">
              Add a text or logo watermark to your video — set position and
              opacity, then export as MP4.
            </p>
          </div>
                  ...
                  <div className="space-y-3 pt-2 border-t border-gray-100">
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className="w-full bg-gray-50 border border-gray-200 rounded-xl px-3 py-2 text-xs font-semibold text-gray-800 focus:outline-none focus:border-amber-500"
                      />
                    </div>
                    ...
                    <div className="py-16 space-y-3">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] text-gray-400 mt-0.5">
                          Configure your watermark, then apply it to the video.
                        </p>
                      </div>
                    </div>
                  ) : (
                    <div className="w-full space-y-4">
                      <div className="max-w-md mx-auto rounded-xl overflow-hidden shadow-md bg-gray-900 p-6 text-white text-center space-y-2 relative">
                        <Stamp size={32} className="mx-auto text-amber-400" />
                        <p className="text-xs font-bold">
                          Watermark &quot;{watermarkText}&quot; ready to apply
                        </p>
                      ...
                      {isProcessed && (
                        <div className="flex items-center justify-center gap-1.5 text-xs font-bold text-emerald-600 bg-emerald-50 py-1.5 px-3 rounded-lg w-max mx-auto">
                          ...
                          <span>
                            Watermark added successfully to your video!
                          </span>
                        </div>
                      )}
                    </div>
        ...
        <div className="bg-white border border-gray-200/80 rounded-2xl p-4 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-2xs">
          <div className="text-xs font-medium text-gray-500 flex items-center gap-2">
            ...
            <span>
              {!selectedFile
                ...
                : isProcessed
                  ? "Ready to download your watermarked file"
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto justify-end">
            ...
            {!isProcessed ? (
              ...
              <button
                onClick={() => alert("Downloading watermarked video...")}
        ...
        <div className="bg-white border border-gray-200/80 rounded-2xl overflow-hidden shadow-2xs">
          ...
          {showHowToUse && (
            <div className="p-4 pt-0 text-xs text-gray-600 space-y-2 border-t border-gray-100 font-medium leading-relaxed">
              ...
              <p>
                2. Enter your watermark text, choose position, and adjust
                opacity.
              </p>
              <p>
                3. Click &quot;Add watermark&quot; and download your output
                video instantly.
              </p>
            </div>
          )}
